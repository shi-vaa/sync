...
logger = logger.child({ endpoint: null, createdBy: null, category: null, stack: null });
...
const error = (message, endpoint = null, createdBy = null, category = null, stack = null) => {
    logger = logger.child({ endpoint, createdBy, category, stack });

    logger.error(message, endpoint, createdBy, category, stack);
};

const debug = (message, endpoint = null, createdBy = null, category = null, stack = null) => {
    logger = logger.child({ endpoint, createdBy, category, stack });

    logger.debug(message, endpoint, createdBy, category, stack);
};

const fatal = (message, endpoint = null, createdBy = null, category = null, stack = null) => {
    logger = logger.child({ endpoint, createdBy, category, stack });
